  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Mognet prerelease is available for nightly testers."
          : "A new Mognet latest release is available.",
...
).pipe(Command.withDescription("Post a Mognet release announcement to Discord."));
