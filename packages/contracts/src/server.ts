...
import { EditorId, ExternalTerminalId, FileManagerRevealKind, RemoteOpenTarget } from "./editor.ts";
...
/**
 * A palette the environment's machine publishes for Mognet to follow, read
 ...
 * over as a coherent Mognet palette instead of a foreign one.
 */
