...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set MOGNET_BITBUCKET_EMAIL and MOGNET_BITBUCKET_API_TOKEN, or MOGNET_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check MOGNET_BITBUCKET_EMAIL and MOGNET_BITBUCKET_API_TOKEN.",
  },
};
