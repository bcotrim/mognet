...
import { MognetProjectFile } from "./mognetProjectFile.ts";

const decode = Schema.decodeUnknownSync(MognetProjectFile);

describe("MognetProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://raw.githubusercontent.com/bcotrim/mognet/main/mognet.schema.json",
