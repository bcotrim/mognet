...
function getGnomeKeyringRemediationMessage(): string {
  return "Mognet could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Mognet.";
}

function getKWalletRemediationMessage(): string {
  return "Mognet could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Mognet.";
}
