...
const MARKDOWN_COLORS = {
  light: {
    ...
    strong: "#f8f8f8",
    link: "#6fe0ea",
    blockquoteBorder: "rgba(255, 255, 255, 0.14)",
    blockquoteBackground: "rgba(255, 255, 255, 0.03)",
    codeBackground: "rgba(255, 255, 255, 0.06)",
    codeText: "#ededed",
    inlineCodeText: "#acacac",
    horizontalRule: "rgba(255, 255, 255, 0.09)",
    userBody: "#062012",
    userCodeBackground: "rgba(6, 32, 18, 0.16)",
    userCodeText: "#062012",
    userInlineCodeText: "rgba(6, 32, 18, 0.72)",
    userFenceBackground: "rgba(6, 32, 18, 0.22)",
    userFenceText: "#062012",
  },
  dark: {
    body: "#ededed",
    strong: "#f8f8f8",
