...
export const DEFAULT_TERMINAL_FONT_FAMILY =
  '"JetBrains Mono", "SF Mono", "SFMono-Regular", Consolas, "Liberation Mono", Menlo, ' +
...
export class GhosttyTerminalSurface {
  ...
  static async create(
    ...
    canvas.className = "mognet-ghostty-canvas";
    canvas.style.cssText = "display:block;width:100%;height:100%;";
    canvas.setAttribute("aria-hidden", "true");

    const input = document.createElement("textarea");
    input.className = "mognet-ghostty-input";
    ...
    scrollbar.className = "mognet-ghostty-scrollbar";
    ...
    scrollbarThumb.className = "mognet-ghostty-scrollbar-thumb";
