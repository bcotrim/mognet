...
export function getStandardThemeColors(appearance: ThemeAppearance): ThemeColors {
  return appearance === "dark" ? MOGNET_DARK_THEME_COLORS : MOGNET_LIGHT_THEME_COLORS;
}
...
export const MOGNET_THEME: ThemeDefinition = {
  ...
  appearance: "light",
  colors: MOGNET_LIGHT_COLORS,
  variants: {
    dark: MOGNET_DARK_COLORS,
  },
};
...
export function getDefaultThemeColors(appearance: ThemeAppearance): ThemeColors {
  return appearance === "dark" ? MOGNET_DARK_COLORS : MOGNET_LIGHT_COLORS;
}
