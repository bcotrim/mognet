...
export const MOBILE_COMPOSER_VIEW_TRANSITION_NAME = "mognet-mobile-composer";
export const MOBILE_DRAFT_HEADLINE_VIEW_TRANSITION_NAME = "mognet-mobile-draft-headline";
