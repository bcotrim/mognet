                ...
                {props.settlementSupported || showSnoozeButton ? (
                  <span
                    className={cn(
                      ...
                      "absolute inset-y-0 right-0 flex items-stretch gap-0.5 opacity-0 transition-opacity has-[:focus-visible]:static has-[:focus-visible]:opacity-100 group-hover/v2-row:static group-hover/v2-row:opacity-100",
...
export default function SidebarV2() {
  ...
  const { pinnedThreads, activeThreads, snoozedThreads, settledThreads, snoozeNow } = useMemo(() => {
