...
const NO_FILE_SCRIPTS: ReadonlyArray<MognetProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in mognet.json, offered for import. */
  fileScripts?: ReadonlyArray<MognetProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: MognetProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From mognet.json</MenuGroupLabel>
            ...
            <TooltipTrigger
              render={
                <Button
                  size="xs"
                  variant="outline"
                  className="size-7 px-0 sm:size-6 @3xl/header-actions:w-auto! @3xl/header-actions:px-[calc(--spacing(2)-1px)]"
          ...
          <TooltipTrigger
            render={
              <Button
                size="xs"
                variant="outline"
                className="h-7 w-7 px-0 sm:h-6 sm:w-6 @3xl/header-actions:w-auto! @3xl/header-actions:px-[calc(--spacing(2)-1px)]"
