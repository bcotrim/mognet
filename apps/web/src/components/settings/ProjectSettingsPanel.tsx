        ...
        >
              ...
              {importableScripts.length > 0 ? (
                <Menu>
                  ...
                  <MenuPopup align="end" className="w-72">
                    <MenuGroup>
                      <MenuGroupLabel>Import from mognet.json</MenuGroupLabel>
          ...
          {mognetFile.status === "invalid" ? (
            <SettingsRow
              ...
              description="A mognet.json exists in this checkout but fails to parse, so every action and icon it declares is ignored. Check the JSON syntax and icon values."
